...
import com.skinfotech.ekinch.utils.easypermissions.helper.PermissionHelper;
...
//            if (SDK_INT >= Build.VERSION_CODES.R && perm.contains("android.permission.MANAGE_EXTERNAL_STORAGE")) {
