...
public class Constant {
    ...
    public static final int REQUEST_CODE_PICK_ANY_FILE = 0X500;

    public static final int REQUEST_CODE_PICK_PAYMENT = 0X600;
    public static final int REQUEST_CODE_IMAGE_VIEW =  0X601;
    public static final int SELECT_ADDRESS =  0X701;
