package com.skinfotech.ekinch.utils.easypermissions;
...
public class AppSettingsDialog implements Parcelable {
    ...
    private final int isManageStoragePermission;
    ...
    private AppSettingsDialog(Parcel in) {
        ...
        isManageStoragePermission = in.readInt();
    ...
    private AppSettingsDialog(@NonNull final Object activityOrFragment,
                              ...
                              int requestCode,
                              int intentFlags,
                              int manageStoragePermission) {
        setActivityOrFragment(activityOrFragment);
        mThemeResId = themeResId;
        mRationale = rationale;
        mTitle = title;
        isManageStoragePermission = manageStoragePermission;
...
//            if (isManageStoragePermission == 1)
//                startForResult(AppSettingsDialogHolderActivity.createManageStorageDialogIntent(mContext, this));
//            else
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        dest.writeInt(isManageStoragePermission);
    ...
    public static class Builder {
        ...
        private int isManageStoragePermission = 0;
        ...
        public Builder setIsManageStoragePermission(int manageStoragePermission) {
            isManageStoragePermission = manageStoragePermission;
            return this;
        }
        ...
        public AppSettingsDialog build() {
            mRationale = TextUtils.isEmpty(mRationale) ?
                    mContext.getString(R.string.hippo_rationale_ask_again) : mRationale;
